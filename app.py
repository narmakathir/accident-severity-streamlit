...
def set_dark_theme():
    # Set seaborn style (only for visualizations)
    sns.set_style("darkgrid")
    
    # Using a dark blue color palette for visualizations
    PALETTE = sns.color_palette("Blues_d")
    
    # Set matplotlib rcParams
    plt.rcParams['figure.facecolor'] = '#0E1117'
    plt.rcParams['axes.facecolor'] = '#0E1117'
    plt.rcParams['axes.edgecolor'] = '#2A3459'
    plt.rcParams['axes.labelcolor'] = 'white'
    plt.rcParams['text.color'] = 'white'
    plt.rcParams['xtick.color'] = 'white'
    plt.rcParams['ytick.color'] = 'white'
    plt.rcParams['grid.color'] = '#1A2138'
...
# Custom CSS for dark theme with minimal color usage
st.markdown("""
<style>
...
<div class="card">
    ...
    <p>Traffic accidents are a major problem worldwide, causing fatalities, property damage, and productivity loss. This application uses machine learning to analyze traffic data and predict accident severity based on factors like weather, road conditions, and vehicle types.</p>
    <p>Authorities can use these predictions to improve emergency responses and road safety measures.</p>
</div>
"""
...
def render_data_analysis():
    ...
    with st.container():
        ...
        try:
            ...
            sns.heatmap(corr, cmap='Blues', annot=False, ax=ax, center=0)
...
def create_sidebar():
    ...
    # Admin mode toggle
    st.session_state.admin_mode = st.sidebar.checkbox("Admin Mode", key="admin_mode_toggle")
    ...
    st.sidebar.markdown(f"**Models:** {len(st.session_state.models)} trained")
